const { validateParams, validateNotExists, validateLengths, validateRole } = require("../../validations/users.validations");
...
module.exports = async (receivedInput) => {
    ...
    if (validationErr) {
        ...
        memory.users.push(await new User(receivedUsername, receivedPassword,receivedRole));
