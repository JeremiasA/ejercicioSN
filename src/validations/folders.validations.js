...
const validateCd = async (receivedInput) => {
    ...
    if (receivedParams.length !== 2)
        console.log(memory.folders.filter(folder=> folder.name=receivedParams[1]))
...
module.exports = { validateParams, validateCd, validateNotExists, validateFolderDestroy, validateDestroyParams };
